...
def main():
    ...
    parser.add_argument("--local_path", type=str, required=True, help="Path to your local model folder")
    parser.add_argument("--username", type=str, required=True, help="Your Hugging Face username")
    parser.add_argument("--model_name", type=str, required=True, help="Name for the new repository")
