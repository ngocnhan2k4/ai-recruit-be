...
} from "@/frameworks/storage/firebase-storage.service";
...
export class UploadController {
  ...
  @ApiOperation({
    ...
    description:
      "Upload any file (image, document, etc.) to Firebase Storage and get a public URL",
  })
  ...
  async uploadFile(
    ...
    try {
      ...
      const result = await this.firebaseStorageService.uploadFile(
        file,
        "uploads",
      );
